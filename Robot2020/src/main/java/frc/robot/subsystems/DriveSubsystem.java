...
public class DriveSubsystem extends SubsystemBase {
    ...
    private final WPI_TalonFX m_masterLeft = new WPI_TalonFX(DriveConstants.kMasterLeftPort);
    private final WPI_TalonFX m_followerLeft = new WPI_TalonFX(DriveConstants.kFollowerLeftPort);
    private final WPI_TalonFX m_masterRight = new WPI_TalonFX(DriveConstants.kMasterRightPort);
    private final WPI_TalonFX m_followerRight = new WPI_TalonFX(DriveConstants.kFollowerRightPort);
